<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveStatus.aspx.cs" Inherits="WebApplication1.LeaveStatus" %>
...
<body>
    ...
    CssClass="sidebar-link">Other Actions</asp:LinkButton>
        ...
        <div class="content">
            <div class="header">
                <h2 class="header-title">Leaves' Status</h2>
            ...
            <div class="section">
                ...
                <div class="instruction-text">
                    Your leave requests for the current month are displayed below.
                </div>

                <asp:Label ID="lblEmptyMessage" runat="server" CssClass="empty-message"></asp:Label>
                
                <asp:GridView ID="gvLeaveStatus" runat="server" CssClass="gridview" AutoGenerateColumns="true"
