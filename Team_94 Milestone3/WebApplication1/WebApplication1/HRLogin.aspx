<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRLogin.aspx.cs" Inherits="WebApplication1.HRLogin" %>
...
<head runat="server">
    ...
    <style>
        ...
        /* Logo placeholder - using HR's green gradient */
        .logo {
            width: 80px;
            height: 80px;
            background: linear-gradient(135deg, #2ecc71, #27ae60); /* Green gradient for HR */
            border-radius: 50%;
        ...
        .input-box:focus {
            border-color: #2ecc71; /* Green focus for HR */
            outline: none;
        ...
        /* Error label - matches first page structure */
        .error-label {
            color: #e74c3c;
            margin-top: 15px;
            display: block;
        ...
        /* Back to Home link - with HR green color */
        .back-home {
            position: absolute;
            top: 15px;
            left: 15px;
            color: #2ecc71; /* HR green color */
