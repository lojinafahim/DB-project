<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deductions.aspx.cs" Inherits="WebApplication1.Deductions" %>
...
<body>
    ...
    CssClass="sidebar-link">Other Actions</asp:LinkButton>
        ...
        <div class="content">
            <div class="header">
                <h2 class="header-title">Deductions</h2>
            ...
            <div class="section">
                ...
                <div class="instruction-text">
                    Enter a month (1-12) to view attendance deductions for that month.
                </div>

                <div class="input-area">
                    <asp:TextBox ID="txtDeductionMonth" runat="server" MaxLength="2" Placeholder="Enter month (1-12)"></asp:TextBox>
                    <asp:Button ID="btnLoadDeductions" runat="server" Text="GO" CssClass="btn" OnClick="btnLoadDeductions_Click" />
                </div>

                <asp:Label ID="lblDeductionsEmpty" runat="server" CssClass="empty-message"></asp:Label>
                <asp:GridView ID="gvDeductions" runat="server" CssClass="gridview" AutoGenerateColumns="true"
                    OnRowDataBound="gvDeductions_RowDataBound"></asp:GridView>
            </div>
        </div>
    </form>
</body>
