...
namespace WebApplication1
{
    public partial class Performance : System.Web.UI.Page
    {
        ...
        private void BindGrid(SqlDataAdapter da)
        {
            DataTable dt = new DataTable();
            da.Fill(dt);
            gvPerformance.DataSource = dt;
            gvPerformance.DataBind();
            lblPerformanceEmpty.Text = (dt.Rows.Count == 0) ? "No performance records found." : "";
        }
        ...
        protected void btnLoadPerformance_Click(object sender, EventArgs e)
        {
            ...
            {
                lblPerformanceEmpty.Text = "Please enter a semester (e.g., S1).";
                return;
            }
            ...
            {
                string query = "SELECT * FROM dbo.MyPerformance(@employee_ID, @period)";
