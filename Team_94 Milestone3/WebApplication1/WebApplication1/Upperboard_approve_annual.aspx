<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upperboard_approve_annual.aspx.cs" Inherits="WebApplication1.ApproveAnnualLeaves" %>
    ...
    <form id="form1" runat="server">
        <div class="main-container">
            ...
            <div class="header">
                ...
                <p>Review and manage annual leave requests from employees. Approve or reject requests based on availability and policies.</p>
            </div>
            
            <!-- Note box -->
            <div class="note-box">
                <strong>Important Note:</strong> As an Upper Board member, you have the authority to approve or reject annual leave requests. Please review each request carefully considering departmental needs and replacement arrangements.
            </div>
            ...
            <div class="content-card">
                <div class="gridview-container">
                    <asp:GridView ID="gvAnnualLeaves" runat="server" AutoGenerateColumns="false" 
                        CssClass="styled-gridview" OnRowCommand="gvAnnualLeaves_RowCommand" 
                        DataKeyNames="request_ID" ShowHeaderWhenEmpty="true"
                        EmptyDataText="No annual leave requests pending approval.">
                        <Columns>
                                ...
                                <ItemTemplate>
                                    <div class="action-buttons">
                                        <asp:Button ID="btnApprove" runat="server" Text="Approve" CommandName="Approve" 
                                            CommandArgument='<%# Eval("request_ID") + "|" + Eval("replacement_emp") %>' 
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                approveButtons.forEach(function(button) {
                    button.addEventListener('click', function(e) {
                        if (!confirm('Are you sure you want to approve this annual leave request?')) {
                            e.preventDefault();
                            return false;
                        }
                    });
                ...
                rejectButtons.forEach(function(button) {
                    button.addEventListener('click', function(e) {
                        if (!confirm('Are you sure you want to reject this annual leave request?')) {
                            e.preventDefault();
                            return false;
                        }
                    });
