<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRAnnualAccidentalLeaves.aspx.cs" 
    Inherits="WebApplication1.HRAnnualAccidentalLeaves" MaintainScrollPositionOnPostback="true" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Annual & Accidental Leaves</title>
    <style>
        body {
        ...
        <div class="container">
            ...
            <div class="header-section">
                <div class="header-left">
                    <h1>Pending Annual & Accidental Leaves</h1>
                </div>
            ...
            <asp:Panel ID="pnlNoData" runat="server" CssClass="empty-message" Visible="false">
                ...
                <p>There are no pending annual or accidental leave requests at this time.</p>
            </asp:Panel>

            <div class="gridview-container">
                <asp:GridView ID="gvAnnualAcc" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="request_ID" OnRowCommand="gvAnnualAcc_RowCommand"
