   ...
   <asp:LinkButton ID="lnkOtherActions" runat="server" OnClick="btnOtherActions_Click" 
    CssClass="sidebar-link">Other Actions</asp:LinkButton>
        ...
        <div class="content">
            <!-- Header -->
            <div class="header">
                <h2 class="header-title">My Attendance</h2>
            ...
            <div class="section">
                ...
                <div class="instruction-text">
                    Your attendance records for the current month are displayed below.
                </div>

                <!-- Empty message - will only appear when it has content -->
                <asp:Label ID="lblAttendanceEmpty" runat="server" CssClass="empty-message"></asp:Label>

                <asp:UpdatePanel ID="upAttendance" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvAttendanceCurrent" runat="server" CssClass="gridview" AutoGenerateColumns="true"></asp:GridView>
                    </ContentTemplate>
                    <Triggers>
                ...
                <!-- Timer for auto-refresh if needed -->
