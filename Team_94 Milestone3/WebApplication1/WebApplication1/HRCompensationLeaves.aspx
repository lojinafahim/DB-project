<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRCompensationLeaves.aspx.cs" 
    Inherits="WebApplication1.HRCompensationLeaves" MaintainScrollPositionOnPostback="true" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Compensation Leaves</title>
    <style>
        body {
        ...
        <div class="container">
            ...
            <div class="header-section">
                <div class="header-left">
                    <h1>Pending Compensation Leaves</h1>
                </div>
            ...
            <asp:Panel ID="pnlNoData" runat="server" CssClass="empty-message" Visible="false">
                ...
                <p>There are no pending compensation leave requests at this time.</p>
            </asp:Panel>

            <div class="gridview-container">
                <asp:GridView ID="gvComp" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="request_ID" OnRowCommand="gvComp_RowCommand"
                    CssClass="gridview" GridLines="None">
                    <Columns>
                        <asp:BoundField DataField="request_ID" HeaderText="Request ID" />
                        <asp:BoundField DataField="emp_ID" HeaderText="Employee ID" />
                        <asp:BoundField DataField="date_of_original_workday" HeaderText="Original Workday" DataFormatString="{0:yyyy-MM-dd}" />
